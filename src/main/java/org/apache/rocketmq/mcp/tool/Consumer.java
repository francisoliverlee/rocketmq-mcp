...
public class Consumer {
    ...
    public String examineSubscriptionGroupConfig(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
    ...
    public String getAllSubscriptionGroup(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                          @ToolParam(description = "access key or ak") String ak,
    ...
    public String examineConsumeStats(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                      @ToolParam(description = "access key or ak") String ak,
                                      @ToolParam(description = "secret key or sk") String sk,
                                      @ToolParam(description = "消费者组名称") String group) throws MQClientException {
        return AdminUtil.callAdmin(admin -> {
    ...
    public String getConsumeJstack(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                   @ToolParam(description = "access key or ak") String ak,
                                   @ToolParam(description = "secret key or sk") String sk,
    ...
    public String createAndUpdateSubscriptionGroupConfig(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                                         @ToolParam(description = "access key or ak") String ak,
                                                         @ToolParam(description = "secret key or sk") String sk,
    ...
    public String createAndUpdateSubscriptionGroupConfigList(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                                             @ToolParam(description = "access key or ak") String ak,
                                                             @ToolParam(description = "secret key or sk") String sk,
    ...
    public String examineConsumeStatsByTopic(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                             @ToolParam(description = "access key or ak") String ak,
                                             @ToolParam(description = "secret key or sk") String sk,
    ...
    public String examineConsumeStatsByCluster(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                               @ToolParam(description = "access key or ak") String ak,
                                               @ToolParam(description = "secret key or sk") String sk,
    ...
    public String examineConsumeStatsWithTimeout(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                                 @ToolParam(description = "access key or ak") String ak,
                                                 @ToolParam(description = "secret key or sk") String sk,
                                                 @ToolParam(description = "broker地址") String brokerAddr,
                                                 @ToolParam(description = "消费者组名称") String consumerGroup,
    ...
    public String examineConsumeStatsConcurrent(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                                @ToolParam(description = "access key or ak") String ak,
                                                @ToolParam(description = "secret key or sk") String sk,
                                                @ToolParam(description = "消费者组名称") String consumerGroup,
                                                @ToolParam(description = "主题名称") String topic) throws MQClientException {
    ...
    public String examineConsumerConnectionInfo(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                                @ToolParam(description = "access key or ak") String ak,
                                                @ToolParam(description = "secret key or sk") String sk,
    ...
    public String examineConsumerConnectionInfoByBroker(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                                        @ToolParam(description = "access key or ak") String ak,
                                                        @ToolParam(description = "secret key or sk") String sk,
                                                        @ToolParam(description = "消费者组名称") String consumerGroup,
    ...
    public String resetConsumerOffset(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                      @ToolParam(description = "access key or ak") String ak,
                                      @ToolParam(description = "secret key or sk") String sk,
                                      @ToolParam(description = "消费者组") String consumerGroup,
    ...
    public String deleteSubscriptionGroup(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                          @ToolParam(description = "access key or ak") String ak,
                                          @ToolParam(description = "secret key or sk") String sk,
                                          @ToolParam(description = "broker地址") String brokerAddr,
    ...
    public String examineConsumerConnectionInfoWithAddr(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                                        @ToolParam(description = "access key or ak") String ak,
                                                        @ToolParam(description = "secret key or sk") String sk,
                                                        @ToolParam(description = "消费者组") String consumerGroup) throws MQClientException {
        return AdminUtil.callAdmin(admin -> {
    ...
    public String exportPopRecords(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                   @ToolParam(description = "access key or ak") String ak,
                                   @ToolParam(description = "secret key or sk") String sk,
                                   @ToolParam(description = "broker地址") String brokerAddr,
    ...
    public String resetOffsetByTimestampOld(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                            @ToolParam(description = "access key or ak") String ak,
                                            @ToolParam(description = "secret key or sk") String sk,
                                            @ToolParam(description = "消费者组") String consumerGroup,
    ...
    public String queryTopicConsumeByWho(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                         @ToolParam(description = "access key or ak") String ak,
                                         @ToolParam(description = "secret key or sk") String sk,
    ...
    public String queryTopicsByConsumer(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                        @ToolParam(description = "access key or ak") String ak,
                                        @ToolParam(description = "secret key or sk") String sk,
    ...
    public String querySubscription(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                    @ToolParam(description = "access key or ak") String ak,
                                    @ToolParam(description = "secret key or sk") String sk,
    ...
    public String queryConsumeTimeSpan(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                       @ToolParam(description = "access key or ak") String ak,
                                       @ToolParam(description = "secret key or sk") String sk,
                                       @ToolParam(description = "主题") String topic,
                                       @ToolParam(description = "消费者组") String group) throws MQClientException {
    ...
    public String setMessageRequestMode(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                        @ToolParam(description = "access key or ak") String ak,
                                        @ToolParam(description = "secret key or sk") String sk,
                                        @ToolParam(description = "broker地址") String brokerAddr,
                                        @ToolParam(description = "主题") String topic,
    ...
    public String resetOffsetByQueueId(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                       @ToolParam(description = "access key or ak") String ak,
                                       @ToolParam(description = "secret key or sk") String sk,
                                       @ToolParam(description = "broker地址") String brokerAddr,
                                       @ToolParam(description = "消费者组") String consumerGroup,
    ...
    public String updateAndGetGroupReadForbidden(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                                 @ToolParam(description = "access key or ak") String ak,
                                                 @ToolParam(description = "secret key or sk") String sk,
                                                 @ToolParam(description = "broker地址") String brokerAddr,
    ...
    public String resetOffsetNew(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                 @ToolParam(description = "access key or ak") String ak,
                                 @ToolParam(description = "secret key or sk") String sk,
                                 @ToolParam(description = "消费者组") String consumerGroup,
                                 @ToolParam(description = "主题") String topic,
    ...
    public String getConsumeStatus(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                   @ToolParam(description = "access key or ak") String ak,
                                   @ToolParam(description = "secret key or sk") String sk,
                                   @ToolParam(description = "主题") String topic,
                                   @ToolParam(description = "消费者组") String group,
    ...
    public String cloneGroupOffset(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                   @ToolParam(description = "access key or ak") String ak,
                                   @ToolParam(description = "secret key or sk") String sk,
    ...
    public String fetchConsumeStatsInBroker(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                            @ToolParam(description = "access key or ak") String ak,
                                            @ToolParam(description = "secret key or sk") String sk,
                                            @ToolParam(description = "broker地址") String brokerAddr,
    ...
    public String getUserSubscriptionGroup(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                           @ToolParam(description = "access key or ak") String ak,
                                           @ToolParam(description = "secret key or sk") String sk,
                                           @ToolParam(description = "broker地址") String brokerAddr,
                                           @ToolParam(description = "超时时间") long timeoutMillis) throws MQClientException {
    ...
    public String updateConsumeOffset(@ToolParam(description = "nameserver/namesrv 地址列表") String nameserverAddressList,
                                      @ToolParam(description = "access key or ak") String ak,
                                      @ToolParam(description = "secret key or sk") String sk,
                                      @ToolParam(description = "broker地址") String brokerAddr,
